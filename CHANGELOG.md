...
* Implemented the 'Transform/Scale Vertices' spell for BSTriShape geometry (Fallout 4, Skyrim: Special Edition, Fallout 76). Note that skin partitions are currently not supported, and normals, tangent space and bounds should be updated after using this spell.
