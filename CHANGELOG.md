...
* When using internal geometry data, the Update Bounds spell also converts the mesh to version 2 and generates meshlets (using code from [DirectXMesh](https://github.com/microsoft/DirectXMesh)).
